...
const passLink = async(user: {lastName: string; email: string; },  link: string,) => {
  ...
  height: 90%; display:block;border-radius: 25px; ";
    ...
    <p style = " margin: auto; padding:2rem;text-align: center; font-family: 'Lato'; font-size:18px";  >Hi ${user.lastName}, <br>Click the button below to reset your password.</p> 
